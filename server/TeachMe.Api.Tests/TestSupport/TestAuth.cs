...
public static class TestAuth
{
    ...
    public static async Task<HttpClient> RegisterAndSignInTeacherAsync(ApiFactory factory, string email, string fullName = "Test Teacher", string password = "Password1", string subject = "General Studies", string phone = "+20 100 000 0000")
    {
        var anon = factory.CreateClient();
        var response = await anon.PostAsJsonAsync("/api/auth/register/teacher", new { fullName, email, password, subject, phone });

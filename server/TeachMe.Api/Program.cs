...
builder.Services.AddScoped<IPasswordHasher<TeachMe.Api.Domain.User>, PasswordHasher<TeachMe.Api.Domain.User>>();
...
if (!app.Environment.IsEnvironment("Testing"))
{
    ...
    if (string.IsNullOrWhiteSpace(adminEmail) || string.IsNullOrWhiteSpace(adminPassword))
    {
        throw new InvalidOperationException(
            ...
            "Run: dotnet user-secrets set \"Seed:AdminEmail\" \"admin@example.test\" --project server/TeachMe.Api " +

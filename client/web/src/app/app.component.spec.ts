...
describe('AppComponent', () => {
  ...
  it('offers a signed-out visitor Discover and nothing else', () => {
    const fixture = TestBed.createComponent(AppComponent);
    expect(fixture.componentInstance.links().map(l => l.path)).toEqual(['/discover']);
  });
  ...
  it('keeps Discover out of an approved teacher toolbar', () => {
    const auth = TestBed.inject(AuthService);
    const approved = {
      userId: '1', email: 't@example.test', fullName: 'A Teacher',
    ...
    const fixture = TestBed.createComponent(AppComponent);
    expect(fixture.componentInstance.links().map(l => l.path)).not.toContain('/discover');
  });

  it('gives a student Discover first', () => {
    const auth = TestBed.inject(AuthService);
    const student = {
    ...
    const fixture = TestBed.createComponent(AppComponent);
    expect(fixture.componentInstance.links()[0].path).toBe('/discover');
  });
});
